            ...
            <div className="flex flex-col gap-6">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex flex-col gap-1">
                        <h2 className="text-3xl font-extrabold text-[#0f172a] tracking-tight">Pedidos</h2>
                ...
                <div className="flex items-center gap-3 overflow-x-auto pb-4 no-scrollbar">
                    {['Todos', ...statusOptions].map((status) => {
                        ...
                        return (
                            ...
                            >
                                {status}
                                <span className={`flex items-center justify-center min-w-[24px] h-[24px] px-2 rounded-full text-[11px] font-black ${isActive ? 'bg-sky-500 text-white' : 'bg-slate-100 text-slate-400'
                                    }`}>
                                    {count}
                                </span>
                            </button>
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="border-b border-slate-50 bg-slate-50/10">
                                <th className="px-6 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] text-center">Data</th>
                                <th className="px-6 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] text-center">Cliente</th>
                                <th className="px-6 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] text-center">Peça</th>
                                <th className="px-6 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] text-center">UF</th>
                                <th className="px-6 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] text-center">Material</th>
                                <th className="px-6 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] text-center">Qtd</th>
                                ...
                                filteredOrdersList.map((order) => (
                                    <tr key={order.id} className="hover:bg-slate-50/50 transition-colors group">
                                        <td className="px-6 py-5 text-center">
                                            <p className="text-sm font-black text-slate-900">{formatDate(order.date)}</p>
                                        </td>
                                        <td className="px-6 py-5 text-center">
                                        ...
                                        <td className="px-6 py-5 text-center">
                                            <span className="bg-slate-100 text-slate-500 text-[10px] font-black px-2 py-1 rounded-md">{order.state}</span>
                                        </td>
                                        <td className="px-6 py-5 text-center">
                                            <div className="flex flex-col items-center">
                                                <span className="text-xs font-bold text-slate-800">{order.material}</span>
                                        ...
                                        <td className="px-6 py-5 text-center">
                                            <div className="flex flex-col items-center">
                                                <span className="text-sm font-black text-sky-600">{formatCurrency(order.total)}</span>
                                        ...
                                        <td className="px-6 py-5 text-center">
                                            <div className="relative inline-block text-left" onClick={(e) => e.stopPropagation()}>
                                                <button
                                                    ...
                                                    className={`flex items-center justify-between gap-2 px-4 py-2 rounded-xl text-[11px] font-black transition-all min-w-[130px] ${getStatusStyle(order.status)} hover:shadow-md active:scale-95`}
                                                >
