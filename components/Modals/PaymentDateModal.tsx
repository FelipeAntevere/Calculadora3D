        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/30 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white rounded-[24px] shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
                <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-emerald-50/50">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs font-semibold text-emerald-600 uppercase tracking-wider">Registrar data do pagamento</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="p-6 space-y-6">
                    {expenseDescription && (
                        <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
                            ...
                            <p className="font-bold text-slate-700">{expenseDescription}</p>
                        </div>
                    )}

                    <div className="space-y-3">
                        <label className="text-sm font-bold text-slate-700 ml-1">Data do Pagamento</label>
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="pl-10 w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-slate-700 outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all"
                            />
                        </div>
                        <button
                ...
                <div className="p-4 bg-slate-50 flex items-center justify-end gap-3 border-t border-slate-100">
                    <button
                        onClick={onClose}
                        className="px-5 py-2.5 text-slate-600 font-bold hover:bg-white hover:text-slate-800 rounded-xl transition-all text-sm"
                    >
                        Cancelar
                    </button>
                    <button
