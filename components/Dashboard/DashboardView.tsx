        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    ...
                    <p className="text-slate-500 font-medium">Visão geral financeira baseada nos pedidos salvos.</p>
                </div>
            ...
            {current.stateDistribution.length > 0 && (
                <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                    <h3 className="text-lg font-bold text-slate-800 mb-6">Pedidos por Estado</h3>
                            ...
                            return (
                                <div key={state.state} className="flex items-center justify-between p-3 rounded-xl bg-slate-50 border border-slate-100">
                                    ...
                                    <div className="text-right pl-2">
                                        <p className="text-xs font-black text-slate-800">{state.percentage.toFixed(1)}%</p>
